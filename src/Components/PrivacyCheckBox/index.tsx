...
const mapStateToProps = (state : PrivacyProps) => ({privacyOne: state.privacyOne, privacyTwo: state.privacyTwo});
...
export const PrivacyChecked = reduxForm({form: "UserDetails", destroyOnUnmount: false})(connectForm);
